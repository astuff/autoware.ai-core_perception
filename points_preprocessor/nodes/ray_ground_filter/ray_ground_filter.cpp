...
void RayGroundFilter::Run()
{
  ...
  pnh_.param("radial_divider_angle", radial_divider_angle_, 0.1);  // 1 degree default
  ...
  pnh_.param("reclass_distance_threshold", reclass_distance_threshold_, 0.2);  // 0.5 meters default
